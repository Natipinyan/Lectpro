...
router.get('/insByDep', middleLog.authenticateToken, middleLog.ensureAdmin, middleReg.getInstructorsByDepartment, (req, res) => {
    try {
...
router.get('/stdByDep', middleLog.authenticateToken, middleLog.ensureAdmin, middleReg.getStudentsByDepartment, (req, res) => {
    try {
...
router.put('/toggle-status/:id', middleLog.authenticateToken, middleLog.ensureAdmin, middleReg.toggleInstructorStatus, (req, res) => {
    try {
...
router.get('/projectsInsByDep', middleLog.authenticateToken, middleLog.ensureAdmin, middleReg.getProjectsAndInstructorsByDepartment, (req, res) => {
        try {
...
router.post('/assignProjectInstructor', middleLog.authenticateToken, middleLog.ensureAdmin, middleReg.assignInstructorToProject, (req, res) => {
        try {
