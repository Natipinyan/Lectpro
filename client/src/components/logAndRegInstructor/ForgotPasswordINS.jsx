...
const ForgotPasswordINS = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                `${process.env.REACT_APP_BASE_URL}/instructor/register/forgot-password`,
                { email },
    ...
    return (
        <div className="forgot-password-container">
            ...
            <button onClick={() => navigate("/instructor")}>חזרה להתחברות</button>
        </div>
    );
};

export default ForgotPasswordINS; 